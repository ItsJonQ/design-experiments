...
class DesignExperiments {
	...
	function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'design_experiments_enqueue_scripts' ), 100 );
	}
	...
	*/
	...
	function design_experiments_enqueue_scripts() {
		$experiment_url = plugins_url( 'js/index.js' , __FILE__ );
		$version = $mtime ? $mtime : time();

		wp_enqueue_script( 'js/index.js', $experiment_url, false, $version );
	}
